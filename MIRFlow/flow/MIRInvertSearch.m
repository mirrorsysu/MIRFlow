...
+ (id<MTLCommandBuffer>)encode_bwd1:(id<MTLCommandBuffer>)commandBuffer
    ...
    {
        id<MTLComputeCommandEncoder> encoder = [commandBuffer computeCommandEncoder];
        [encoder setLabel:@"MIRFlow_invertSearch_bwd1"];
        id<MTLComputePipelineState> pso = [MIRMetalContext computePSOWithFuncName:@"MIRFlow_invertSearch_bwd1"];
        [encoder setComputePipelineState:pso];
...
+ (id<MTLCommandBuffer>)encode_bwd2:(id<MTLCommandBuffer>)commandBuffer
    ...
    {
        id<MTLComputeCommandEncoder> encoder = [commandBuffer computeCommandEncoder];
        [encoder setLabel:@"MIRFlow_invertSearch_bwd2"];
        id<MTLComputePipelineState> pso = [MIRMetalContext computePSOWithFuncName:@"MIRFlow_invertSearch_bwd2"];
        [encoder setComputePipelineState:pso];
